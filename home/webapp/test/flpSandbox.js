		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Título Oi Pessoal.",
									"targetURL": "#brcomhomehome-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomhomehome-display": {
								"semanticObject": "brcomhomehome",
								"action": "display",
								"description": "Págine home",
								"title": "Título Oi Pessoal.",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.home.home",
									"url": sap.ui.require.toUrl("br/com/home/home")
								}
							}
						}
					}
